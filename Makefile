...
# Development
build:
	xcodebuild -scheme forest -configuration Debug -destination 'platform=macOS' build

check:
	xcodebuild -scheme forest -configuration Debug -destination 'platform=macOS' build -quiet
...
test:
	xcodebuild -scheme forest -configuration Debug -destination 'platform=macOS' test -quiet
